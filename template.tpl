...

{
  ...
  "description": "If you\u0027re a Bambuser customer this template is an easy way to set up the Bambuser Live Shopping conversion tracker, Video Consultation or Shoppable video on your website.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  ...
  },
  {
    ...
    "simpleValueType": true,
    "help": "Unique identifier for a placed Order - Can be String or Number",
    "valueHint": "order ID,  e.g. 12345",
    "valueValidators": [
      {
        "type": "NON_EMPTY",
  ...
  },
  {
    ...
    "simpleValueType": true,
    "help": "Total cost of the Order -  Must be Number",
    "valueHint": "Total value of order, e.g. 1000",
    "valueValidators": [
      {
        "type": "NON_EMPTY",
  ...
  },
  {
    ...
    "simpleValueType": true,
    "help": "A comma-separated string or an array of product IDs that were part of the Order.\nE.g.  \u0027123,456,789\u0027 or [\u0027123\u0027, \u0027456\u0027, \u0027789\u0027]",
    "valueHint": "IDs of products in order, e.g. 123,456,789",
    "valueValidators": [
      {
        "type": "NON_EMPTY",
  ...
  },
  {
    ...
    "simpleValueType": true,
    "help": "Currency in which the Order Value was paid. \nList of supported currencies is available on \u003ca href\u003d\u0027https://fixer.io/symbols\u0027\u003ehttps://fixer.io/symbols\u003c/a\u003e",
    "valueHint": "Currency of order, e.g. SEK, EUR, USD, etc",
    "valueValidators": [
      {
        "type": "NON_EMPTY",
    ...
    "subParams": [
      {
        ...
        "simpleValueType": true,
        "help": "Logs debugging information on browser console"
      },
      {
        "type": "TEXT",
        "name": "scriptUrl",
        ...
        "valueHint": "E.g. https://cdn.liveshopping.bambuser.com/metrics/bambuser.min.js",
        "valueValidators": [
          {
            "type": "REGEX",
            "args": [
            ...
            "errorMessage": "Please insert a valid URL including!",
            "enablingConditions": []
          }
        ],
