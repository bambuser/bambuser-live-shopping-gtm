...

{
  ...
  "description": "Used to send Purchases related to Bambuser Live Shopping. Dependency: bambuser.js.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    ...
    "help": "Unique identifier for a placed Order",
    "valueHint": "order/transaction ID, e.g. 12345",
    "valueValidators": [
      {
        "type": "NON_EMPTY",
