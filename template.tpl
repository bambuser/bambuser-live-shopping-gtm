...

{
  ...
  "description": "If you\u0027re a Bambuser customer this template is an easy way to set up the Bambuser Live Shopping conversion tracker or integrate One-to-One on your website.",
  "containerContexts": [
    "WEB"
  ]
}
